...
class GameCategoryActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        categoryHeading.text= com.itg.itggaming.gameCategories.categoryData.category
        setRecyclerView()
    }
    ...
    private fun setRecyclerView() {
        ...
        val gameData= com.itg.itggaming.gameCategories.categoryData.games
    ...
    private fun setData(serializableExtra: Serializable?) {
        com.itg.itggaming.gameCategories.categoryData = serializableExtra as GameList
    }
